...
- Si la sauvegarde n'est pas valide, essayez une autre sauvegarde en la téléversant dans le dossier `/palworld - verygames/Pal/Saved/SaveGames/0`. Répétez cette étape jusqu'à trouver une sauvegarde valide.
